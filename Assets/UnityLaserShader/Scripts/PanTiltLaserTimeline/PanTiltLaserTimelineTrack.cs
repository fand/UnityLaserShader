...
[TrackBindingType(typeof(PanTiltLaser))]
public class PanTiltLaserTimelineTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        var playableDirector = go.GetComponent<PlayableDirector>();
        var mixer = ScriptPlayable<PanTiltLaserTimelineMixerBehaviour>.Create(graph, inputCount);
